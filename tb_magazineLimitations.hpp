class cfgMagazines
{
	class magazineLimitations
	{
		...
		{
			magazineArray[] = {"rhsusf_mag_6Rnd_M441_HE","rhsusf_mag_6Rnd_M433_HEDP","rhsusf_mag_6Rnd_M714_white","rhsusf_mag_6Rnd_M713_red","rhsusf_mag_6Rnd_M713_green","rhsusf_mag_6Rnd_M585_white","rhsusf_mag_6Rnd_M585_green","rhsusf_mag_6Rnd_M585_red"};
			limit = 5;
			limtResistance = 5;
